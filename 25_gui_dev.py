...
class Calculator:
    ...
    def button_press(self, value):
        ...
        self.calc_value = float(entry_val)
    ...
    def math_button_press(self, value):
        if self.is_float(str(self.number_entry.get())):
            ...
            self.number_entry.delete(0, "end")
            self.number_entry.insert(0, str(self.calc_value))
    ...
    def __init__(self, root):
        ...
        self.button_mul = ttk.Button(root, text="*", command=lambda: self.math_button_press("*").grid(row=2, column=3))
        # third row
